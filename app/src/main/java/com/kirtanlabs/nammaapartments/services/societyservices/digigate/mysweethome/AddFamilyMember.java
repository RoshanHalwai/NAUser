...
public class AddFamilyMember extends BaseActivity implements View.OnClickListener, View.OnFocusChangeListener {
                ...
                case REQ_PICK_PICTURE_FROM_GALLERY:
                    EasyImage.handleActivityResult(requestCode, resultCode, data, this, new DefaultCallback() {
                        ...
                        public void onImagePicked(File imageFile, EasyImage.ImageSource source, int type) {
                            Bitmap familyMemberProfilePic = getBitmapFromFile(AddFamilyMember.this, imageFile);
                            circleImageView.setImageBitmap(familyMemberProfilePic);
    ...
    private void storeFamilyMembersDetails() {
        ...
        familyMemberMobileNumberReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                UploadTask uploadTask = storageReference.putBytes(getByteArrayFromFile(AddFamilyMember.this, profilePhotoPath));
    ...
    private void validateFields() {
        ...
        if (!isValidPersonName(familyMemberName) && isValidPhone(mobileNumber) && !isValidEmail(familyMemberEmail) && profilePhotoPath != null) {
            if (grantedAccess)
