...
import static com.kirtanlabs.nammaapartments.utilities.Constants.FIREBASE_CHILD_DAILYSERVICE_TYPE;
...
public class AddDailyService extends BaseActivity implements View.OnClickListener, View.OnFocusChangeListener, TimePickerDialog.OnTimeSetListener {
                ...
                case REQ_PICK_PICTURE_FROM_GALLERY:
                    EasyImage.handleActivityResult(requestCode, resultCode, data, this, new DefaultCallback() {
                        ...
                        public void onImagePicked(File imageFile, EasyImage.ImageSource source, int type) {
                            Bitmap dailyServiceProfilePic = getBitmapFromFile(AddDailyService.this, imageFile);
    ...
    private void validateFields() {
        ...
        if (!isValidPersonName(dailyServiceName) && isValidPhone(mobileNumber) && !TextUtils.isEmpty(pickTime) && profilePhotoPath != null) {
     ...
     *
     * @param dailyServiceType root of DailyService reference
     */
    private void storeDailyServiceDetails(String dailyServiceType) {
        ...
        dailyServiceMobileNumberReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                dailyServiceTypeReference.child(dailyServiceUID).setValue(dailyServiceType);

                /*Store daily service details in Firebase*/
                DatabaseReference dailyServicePublicReference = PUBLIC_DAILYSERVICES_REFERENCE.child(dailyServiceType);
                ...
                UploadTask uploadTask = storageReference.putBytes(getByteArrayFromFile(AddDailyService.this, profilePhotoPath));
                ...
                uploadTask.addOnSuccessListener(taskSnapshot -> {
                    ...
                    NammaApartmentDailyService nammaApartmentDailyService = new NammaApartmentDailyService(
                            dailyServiceUID, fullName, dailyServiceType,
