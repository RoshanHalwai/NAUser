...
public class RaiseAlarm extends BaseActivity {
    ...
    private void storeEmergencyDetails() {
        ...
        digitalGateReference.child(emergencyUID).setValue(true);
        ...
        //Store the details of emergency in emergencies->
        ...
        emergencyDetailsReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String emergencyType = String.valueOf(alarmType);
                NammaApartmentEmergency nammaApartmentEmergency = new NammaApartmentEmergency(emergencyType, flatMemberName, flatMemberMobileNo, flatMemberBlock, flatNumber);
