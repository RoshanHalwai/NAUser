...
import com.kirtanlabs.nammaapartments.nammaapartmentsservices.digitalgate.mydailyservices.DailyServices;
        ...
        gridViewDigitalGateServices.setOnItemClickListener((parent, view, position, id) -> {
            switch (position) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    startActivity(new Intent(DigitalGateHome.this, DailyServices.class));
                    break;
                case 3:
